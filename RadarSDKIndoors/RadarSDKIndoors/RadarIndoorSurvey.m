...
- (void)start:(NSString *)placeLabel forLength:(int)surveyLengthSeconds withKnownLocation:(CLLocation *)knownLocation isWhereAmIScan:(BOOL)isWhereAmIScan withCompletionHandler:(RadarIndoorsSurveyCompletionHandler)completionHandler {
    NSLog(@"RadarIndoorSurvey start called with placeLabel: %@, surveyLengthSeconds: %d, isWhereAmIScan: %d", placeLabel, surveyLengthSeconds, isWhereAmIScan);
    ...
    NSLog(@"calling Radar getLocationWithDesiredAccuracy");
    [Radar getLocationWithDesiredAccuracy:RadarTrackingOptionsDesiredAccuracyMedium
                        completionHandler:^(RadarStatus status, CLLocation *_Nullable location, BOOL stopped) {
                            ...
                            NSLog(@"setting locationAtTimeOfSurveyStart TO: %@", location);
...
- (void)stopScanning {
    ...
    isSimulator = YES;
#endif
    NSLog(@"isSimulator: %d", isSimulator);
    ...
    */
    ...
    NSLog(@"calling removeAllObjects, clearing scanId, etc.");
...
- (void)centralManager:(CBCentralManager *)central didDiscoverPeripheral:(CBPeripheral *)peripheral advertisementData:(NSDictionary<NSString *,id> *)advertisementData RSSI:(NSNumber *)RSSI {
    ...
    NSMutableArray<NSURLQueryItem *> *queryItems = [NSMutableArray arrayWithArray:@[
        ...
        [NSURLQueryItem queryItemWithName:@"sdkVersion" value:[Radar sdkVersion]],
        [NSURLQueryItem queryItemWithName:@"deviceType" value:@"iOS"],
        [NSURLQueryItem queryItemWithName:@"deviceMake" value:@"Apple"],
        [NSURLQueryItem queryItemWithName:@"deviceModel" value:[self deviceModel]],
        [NSURLQueryItem queryItemWithName:@"deviceOS" value:[[NSProcessInfo processInfo] operatingSystemVersionString]],
