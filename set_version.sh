...
sed_inplace "s/s.version( +)= '(.+)'/s.version\1= '$version_full'/" RadarSDKFraud.podspec
...
sed_inplace "s/MARKETING_VERSION = .+;/MARKETING_VERSION = $version;/" RadarSDKFraud/RadarSDKFraud.xcodeproj/project.pbxproj
