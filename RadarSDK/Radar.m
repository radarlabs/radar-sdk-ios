...
@interface Radar_Swift : NSObject
+ (Radar_Swift * _Nonnull)shared;
- (void)mockTrackingWithOrigin:(CLLocation * _Nonnull)origin destination:(CLLocation * _Nonnull)destination mode:(RadarRouteMode)mode steps:(NSInteger)steps interval:(NSTimeInterval)interval onTrack:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull))onTrack completionHandler:(void (^ _Nonnull)(void))completionHandler;
@end
