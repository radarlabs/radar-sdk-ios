...
/**
 A delegate for client-side delivery of events, location updates, and debug logs. For more information, see https://radar.io/documentation/sdk
...
/**
 Tells the delegate that client's location was updated. To receive only server-synced location updates and user state, use `didUpdateLocation:user:` instead.
