...
- (void)autocompleteQuery:(NSString *_Nonnull)query near:(CLLocation *_Nonnull)near layers:(NSArray<NSString *> *_Nullable)layers limit:(int)limit completionHandler:(RadarGeocodeAPICompletionHandler _Nonnull)completionHandler;
