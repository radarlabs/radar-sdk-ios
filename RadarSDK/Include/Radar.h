...
/**
 ...
 @see https://radar.com/documentation/fraud
 */
+ (void)getVerifiedLocationToken:(RadarTrackVerifiedCompletionHandler _Nullable)completionHandler NS_SWIFT_NAME(getLastVerifiedLocationToken(completionHandler:));
